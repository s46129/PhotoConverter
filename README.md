...
1. **[⬇ Download PhotoConverter.zip](https://github.com/s46129/PhotoConverter/releases/download/v2.0.0/PhotoConverter_v2.0.0.zip)** — the ZIP downloads automatically
...
1. **[⬇ 點此下載 PhotoConverter.zip](https://github.com/s46129/PhotoConverter/releases/download/v2.0.0/PhotoConverter_v2.0.0.zip)** — 點擊連結，ZIP 會自動下載
